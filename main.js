...
window.projects = [
  {
	...
	downloadUrl: "https://goatzy.games/projects/flappy-vhs"
  },
  {
	...
	downloadUrl: "https://www.goatzy.games/projects/portfolio-website"
  },
  {
	...
	downloadUrl: "https://goatzy.games/projects/the-last-customer"
  },
  {
	...
	downloadUrl: "https://goatzy.games/projects/1-speed-per-second"
  },
  {
    name: "Invert Nest",
    tags: ["invert", "nest"],
	...
	downloadUrl: "https://goatzy.games/projects/invert-nest"
  },
  {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const sorted = [...window.projects].sort((a, b) => new Date(b.date) - new Date(a.date));

  // Take the latest
  const latest = sorted[0];

  // Render latest project into container
  ...
  if (container && latest) {
    container.innerHTML = `
      <div class="project-card">
        ...
        ${latest.images?.length ? `<img src="${latest.images[0]}" alt="${latest.name}" style="width:100%;" id="special-img">` : ""}
